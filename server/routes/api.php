...
Route::get('/', function (Request $request) {
    return response()->json([
        'message' => 'Welcome to the Dz MYS API!',
        'version' => getVersion(),
        'ip' => $request->ip(),
    ]);
});
    ...
    Route::group(['prefix' => 'servers'], function () {
        ...
        Route::post('/check_name', [ServerController::class, 'checkName']);
         ...
         Route::group(['prefix' => 'console'], function () {
            Route::match(['get', 'post'], '/open', [Server\ConsoleController::class, 'openConsole']);
            Route::get('/check', [Server\ConsoleController::class, 'checkConnection']);
            Route::post('/refresh', [Server\ConsoleController::class, 'refreshConnection']);
            Route::delete('/remove', [Server\ConsoleController::class, 'removeConnection']);
            Route::get('/sessions', [Server\ConsoleController::class, 'getActiveSessions']);
            Route::delete('/sessions/{session_id}', [Server\ConsoleController::class, 'killSession']);
        });
