...
return [
    ...
    */
    ...
    "GUACAMOLE_ADD_FAILED" => ":name Server Guacamole not added: :error",
    "GUACAMOLE_UPDATE_FAILED" => ":name Server Guacamole not updated: :error",
    "GUACAMOLE_REMOVE_FAILED" => ":name Server Guacamole could not be removed: :error",
];
